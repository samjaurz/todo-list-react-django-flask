...
const TaskRow = ({task, isEditing, onEdit, onSave ,handleCancel, onDelete }: Props) => {

    const [value, setValue] = useState(task.name);
    const [statusCompleted, setStatusCompleted] = useState(task.status ? "completed" : "incomplete");
            ...
            <tr className="bg-white">
                ...
                <td className="text-right p-4">
                    <div className="inline-flex space-x-2">
                        ...
                        <button className="bg-red-500 hover:bg-red-600 text-white rounded p-2 cursor-pointer">
    ...
    return (
        <tr key={task.id}
            ...
            <td className="text-right p-3">
                <div className="inline-flex space-x-2">
                    <button className="bg-blue-500 hover:bg-blue-600 text-white p-2 rounded cursor-pointer">
